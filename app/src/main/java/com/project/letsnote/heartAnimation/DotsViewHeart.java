...
public class DotsViewHeart extends View {
    private static final int DOTS_COUNT = 7;
    private static final int OUTER_DOTS_POSITION_ANGLE = 360 / DOTS_COUNT;

    private static final int COLOR_1 = 0xFFff6f6f;
    private static final int COLOR_2 = 0xFFff8080;
    private static final int COLOR_3 = 0xFF800000;
    private static final int COLOR_4 = 0xFFce0000;
    ...
    public DotsViewHeart(Context context) {
        super(context);
        init();
    }

    public DotsViewHeart(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DotsViewHeart(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public DotsViewHeart(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public static final Property<DotsViewHeart, Float> DOTS_PROGRESS = new Property<DotsViewHeart, Float>(Float.class, "dotsProgress") {
        @Override
        public Float get(DotsViewHeart object) {
            return object.getCurrentProgress();
        }

        @Override
        public void set(DotsViewHeart object, Float value) {
