...
import com.project.letsnote.starAnimation.Utils;


public class CircleViewHeart extends View {
    private static final int START_COLOR = 0xFFff6f6f;
    private static final int END_COLOR = 0xFFce0000;
    ...
    public CircleViewHeart(Context context) {
        super(context);
        init();
    }

    public CircleViewHeart(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CircleViewHeart(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public CircleViewHeart(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public static final Property<CircleViewHeart, Float> INNER_CIRCLE_RADIUS_PROGRESS =
            new Property<CircleViewHeart, Float>(Float.class, "innerCircleRadiusProgress") {
                @Override
                public Float get(CircleViewHeart object) {
                    return object.getInnerCircleRadiusProgress();
                }

                @Override
                public void set(CircleViewHeart object, Float value) {
                    object.setInnerCircleRadiusProgress(value);
                }
            };

    public static final Property<CircleViewHeart, Float> OUTER_CIRCLE_RADIUS_PROGRESS =
            new Property<CircleViewHeart, Float>(Float.class, "outerCircleRadiusProgress") {
                @Override
                public Float get(CircleViewHeart object) {
